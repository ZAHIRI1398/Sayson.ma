...
const products: Product[] = [
  ...
  { name: 'Sapin décoré sur mesure', ref: 'SA-001', category: 'Sapins', material: 'Qualité premium', dimensions: 'H jusqu'au 10 mètres', image: '/images/sapin1.jpg', tone: 'Vert naturel', price: 'Sur devis' },
  { name: 'Sapin décoré sur mesure', ref: 'SA-002', category: 'Sapins', material: 'Qualité premium', dimensions: 'H jusqu'au 10 mètres', image: '/images/sapin2.jpg', tone: '', price: 'Sur devis' },
  { name: 'Sapin décoré sur mesure', ref: 'SA-003', category: 'Sapins', material: 'Qualité premium', dimensions: 'H jusqu'au 10 mètres', image: '/images/sapin3.jpg', tone: '', price: 'Sur devis' },
  { name: 'Sapin décoré sur mesure', ref: 'SA-004', category: 'Sapins', material: 'Qualité premium', dimensions: 'H jusqu'au 10 mètres', image: '/images/sapin4.jpg', tone: '', price: 'Sur devis' },
  { name: 'Cotillons de Noël sur mesure', ref: 'PR-001', category: 'cotillons', material: 'Pack sur mesure', dimensions: 'À l’échelle', image: '/images/profess1.jpg', tone: '', price: 'Sur devis' },
  { name: 'Cotillons de Noël sur mesure', ref: 'PR-002', category: 'cotillons', material: 'Pack sur mesure', dimensions: 'À l’échelle', image: '/images/profess2.jpg', tone: '', price: 'Sur devis' },
  { name: 'Cotillons de Noël sur mesure', ref: 'PR-003', category: 'cotillons', material: 'Pack sur mesure', dimensions: 'À l’échelle', image: '/images/profess3.jpg', tone: '', price: 'Sur devis' },
...
function App() {
  ...
  return <main>
    ...
    <section className="catalogue" id="catalogue">
      ...
      <button className="all-products" onClick={() => { setActiveCategory('Boules et deco nouvel an'); setQuery(''); document.getElementById('catalogue')?.scrollIntoView({ behavior: 'smooth' }) }}>Voir tous les catalogues <ArrowRight size={16}/></button>
    </section>
