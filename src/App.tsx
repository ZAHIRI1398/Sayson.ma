...
const products: Product[] = [
  ...
  { name: 'Sapin décoré sur mesure', ref: 'SA-001', category: 'Sapins', material: 'PVC premium', dimensions: 'H 210 cm', image: '/images/sapin1.jpg', tone: 'Vert naturel', price: 'Sur devis' },
  { name: 'Sapin décoré sur mesure', ref: 'SA-002', category: 'Sapins', material: 'Mélange PE', dimensions: 'H 240 cm', image: '/images/sapin2.jpg', tone: 'Blanc / or', price: 'Sur devis' },
  { name: 'Sapin décoré sur mesure', ref: 'SA-003', category: 'Sapins', material: 'PVC', dimensions: 'H 300 cm', image: '/images/sapin3.jpg', tone: 'Or / champagne', price: 'Sur devis' },
